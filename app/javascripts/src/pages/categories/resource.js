...
function Category() {
  ...
  var _useState9 = (0, _react.useState)(null),
    ...
    currentResource = _useState0[0],
    setCurrentResource = _useState0[1];
  ...
  var selectedRows = (0, _react.useMemo)(function () {
    return resource.filter(function (_, index) {
  ...
  var fetchResource = /*#__PURE__*/function () {
  ...
  var can_edit = permissions.can_edit;
  ...
  var handleBulkDelete = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      var response, notice, _err$response, _error, _t2;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            ...
            _context2.p = 1;
            _context2.n = 2;
            return (0, _categoriesApi.bulkDelete)({
              ids: selectedRows.map(function (cat) {
                return cat.id;
              })
            });
          case 2:
          ...
          case 4:
            _context2.p = 4;
            _t2 = _context2.v;
            _error = (_t2 === null || _t2 === void 0 || (_err$response = _t2.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.error) || 'An error occurred';
            _sonner.toast.error(_error);
          case 5:
            _context2.p = 5;
            setRowSelection({});
            setDialogOpen(false);
  ...
  var ResourceColumns = (0, _columnDef.createColumns)([].concat(_toConsumableArray(can_edit ? [{
    key: "index",
    header: "ID",
