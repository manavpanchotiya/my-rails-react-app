...
function DeleteAccount() {
  ...
  function _onSubmit() {
    _onSubmit = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            _context.p = 1;
            _context.n = 2;
            return (0, _usersApi.destroy)();
          case 2:
            response = _context.v;
            notice = response.data.notice; // Show the success message
            _sonner.toast.success(notice);
            if (response.data.success) {
              dispatch((0, _authActions.destroyUser)());
