...
var _excluded = ["resource", "onSave"]; // Import form schema
...
function ResourceForm(_ref) {
  ...
  var form = (0, _reactHookForm.useForm)({
    ...
    defaultValues: {
      name: (_resource$name = resource === null || resource === void 0 ? void 0 : resource.name) !== null && _resource$name !== void 0 ? _resource$name : "" // Set default name for edit, empty for new
    }
  });
  (0, _react.useEffect)(function () {
    var _resource$name2;
    form.reset({
      name: (_resource$name2 = resource === null || resource === void 0 ? void 0 : resource.name) !== null && _resource$name2 !== void 0 ? _resource$name2 : ""
    });
  }, [resource, form]);
  ...
  function _onSubmit() {
    _onSubmit = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(input) {
      var _props$onOpenChange, response, notice, _props$onOpenChange2, _response, _notice, errors, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            _context.n = 2;
            return (0, _rolesApi.update)(resource.id, input);
          case 2:
            response = _context.v;
          ...
          case 3:
            _context.n = 4;
            return (0, _rolesApi.create)(input);
          case 4:
