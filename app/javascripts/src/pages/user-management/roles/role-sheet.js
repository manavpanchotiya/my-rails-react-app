...
exports.RoleSheet = RoleSheet;
var _dialog = require("@/components/ui/dialog");
var _form = require("./form");
var _excluded = ["modelName", "resource", "onSave"]; // Import form schema
function _extends() {
...
function RoleSheet(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_dialog.Dialog, props, /*#__PURE__*/React.createElement(_dialog.DialogContent, {
    ...
    resource: resource,
    onSave: onSave
  }, props))), /*#__PURE__*/React.createElement(_dialog.DialogFooter, null)));
}